...
class Board {
    ...
    checkNumber(drawnNumber: number): boolean {
        ...
        this.isBingo = (this.board[0] + this.board[1] + this.board[2] + this.board[3] + this.board[4] == 5)
